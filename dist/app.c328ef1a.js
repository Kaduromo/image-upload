...
function upload(selector) {
  ...
  var changeHandler = function changeHandler(e) {
    ...
    files = Array.from(e.target.files); // При повторном выборе, уже выбранные картинки сбрасываются
  ...
  var removeHandler = function removeHandler(event) {
    ...
    var block = preview.querySelector("[data-name=\"".concat(name, "\"]")).closest(".preview__image");
  ...
  onUpload: function onUpload(files, blocks) {
    files.forEach(function (file, index) {
      ...
      uploadTask.on("state_changed", function (snapshot) {
        ...
        var block = blocks[index].querySelector(".preview__progress");
...
var ImageRef = (0, _storage.ref)(storage, "images/");
(0, _storage.listAll)(ImageRef).then(function (response) {
  console.log(response);
  response.items.forEach(function (item) {
    console.log(item);
    (0, _storage.getDownloadURL)(item).then(function (url) {
  ...
  response.items.forEach(function (item) {
    (0, _storage.getDownloadURL)(item).then(function (url) {
      blockBody.insertAdjacentHTML("afterbegin", "<div><img src=\"".concat(url, "\" alt=\"").concat(url, "\" /></div>"));
      card.append(block);
    });
  });
});
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/storage":"node_modules/firebase/storage/dist/index.esm.js","./upload":"upload.js","./css/main.scss":"css/main.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
